...
INSERT INTO `company` (`id`, `description`, `label_logo`, `mail_address`, `name`, `state`, `website_url`) VALUES
...
INSERT INTO `admin` (`id`, `id_user`) VALUES (1, 1);
...
INSERT INTO `student` (`id`, `description`, `label`, `label_picture`, `school_year`, `state`, `id_user`) VALUES
